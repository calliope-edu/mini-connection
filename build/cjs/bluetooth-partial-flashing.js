...
class BluetoothPartialFlashSession {
    ...
    async openCharacteristic() {
        let service;
        try {
            service = await this.server.getPrimaryService(exports.PARTIAL_FLASH_SERVICE_UUID);
        }
        catch {
            throw new BluetoothPartialFlashServiceMissingError();
        }
        const ch = await service.getCharacteristic(exports.PARTIAL_FLASH_CHARACTERISTIC_UUID);
