...
export const PARTIAL_FLASH_SERVICE_UUID = profile.partialFlashing.id;
export const PARTIAL_FLASH_CHARACTERISTIC_UUID = profile.partialFlashing.characteristics.control.id;
 ...
 * MakeCode region.
 */
export function parseMakeCodeHex(hex) {
